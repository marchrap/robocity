...
from animate_robots import animate_robots, progress_bar2
...
if __name__ == "__main__":
    ...
    for index, routing_mode in enumerate(routing_modes):
        ...
        # ax.xlabel(routing_mode, fontsize='large')
        # plt.tight_layout()

        ax.annotate(routing_mode, (0.5, -0.025), (0, 0), xycoords='axes fraction', textcoords='offset points',
    ...
    print("Saving render...")
    render = ani.save("animation%s.mp4" % timestr, fps=150, dpi=10, progress_callback=progress_bar2)
